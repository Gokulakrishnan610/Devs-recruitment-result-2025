    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="max-w-lg w-full">
        <div className="mb-6">
          <button
            onClick={onBack}
            className="inline-flex items-center space-x-2 text-slate-400 hover:text-cyan-400 transition-all duration-300 px-3 py-2 rounded-lg hover:bg-slate-800/30"
          >
            <ArrowLeft size={20} />
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-slate-700/50">
          <div className="text-center mb-6">
            <div className="bg-gradient-to-br from-slate-700 to-slate-600 rounded-xl w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-xl border border-slate-600">
          ...
          <div className="relative">
            ...
            <div className="bg-gradient-to-br from-slate-700 via-slate-600 to-slate-700 rounded-xl p-8 text-center min-h-[240px] flex items-center justify-center border border-slate-600/50 shadow-xl">
              {isSelected ? (
                <div className="text-white">
                  ...
                  <p className="text-lg mb-3 text-slate-300">You have been selected as</p>
            ...
            <canvas
              ref={canvasRef}
              className={`absolute inset-0 w-full h-full rounded-xl cursor-pointer transition-opacity duration-500 ${
